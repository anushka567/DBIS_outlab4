...
const teacher_logo=require('../Assets/teacher-logo.jpg')
const prereq_logo=require('../Assets/prereq-logo.jpg')
             ...
             <h4>Instructors</h4>
                {Object.keys(courseinstr).length ? (
                 ...
                 <h5 class="card-title"> S :  {item.sec_id}</h5>
                         ...
                         <Card.Img variant="top" src={teacher_logo}  />
                       </Card.Body>
                     </Card>
                   </Col> 
                ...
                {Object.keys(courseprereq).length ? (
                    ...
                    <Card >
                      <Card.Body>
                        ...
                        <Card.Img variant="top" src={prereq_logo} />
